...
namespace Z2.Services.Externo
{
    ...
    public class GeminiServicos : IGeminiServicos
    {
        ...
        {
            APIModel conf = await _apis.Obter(idGemini); // 1 = ID DO GEMINI NO BANCO --- TALVEZ PASSAR PARA O PROGRAMA
        ...
        {
            APIModel conf = await _apis.Obter(1); // 1 = ID DO GEMINI NO BANCO --- TALVEZ PASSAR PARA O PROGRAMA
